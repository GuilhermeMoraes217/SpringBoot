package com.example.apirest.fragments.contas.mes;
...
import com.example.apirest.activity.contas.mes.ContasPagarInformacoesMesActivity;
import com.example.apirest.activity.contas.semana.ContasPagarInformacoesSemanaActivity;
...
public class RelatorioContasPagarMesFragment extends Fragment implements AdapterRelatorioContasPagarDia.ItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_relatorio_contas_pagar_mes, container, false);
    ...
    public void onClick(CCompra cCompra) {
        Intent intent = new Intent(getActivity(), ContasPagarInformacoesMesActivity.class);
