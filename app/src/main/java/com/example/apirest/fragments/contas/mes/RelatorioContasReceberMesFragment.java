...
import com.example.apirest.activity.contas.dia.ContasReceberInformacoesDiaActivity;
...
public class RelatorioContasReceberMesFragment extends Fragment implements AdapterRelatorioContasReceberDia.ItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_relatorio_contas_receber_mes, container, false);
    ...
    public void onClick(VendasMaster cReceber) {
        Intent intent = new Intent(getActivity(), ContasReceberInformacoesMesActivity.class);
