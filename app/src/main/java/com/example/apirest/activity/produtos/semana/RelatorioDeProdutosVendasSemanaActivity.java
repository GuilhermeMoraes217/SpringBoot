...
public class RelatorioDeProdutosVendasSemanaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_relatorio_de_produtos_vendas_semana);
    ...
    private void configTabsLayout(){
        ...
        viewPagerAdapter.addFragment(new RelatorioProdutosVendasSemanaFragment(), "Produtos");
        viewPagerAdapter.addFragment(new RelatorioGruposVendasSemanaFragment(), "Grupos");
