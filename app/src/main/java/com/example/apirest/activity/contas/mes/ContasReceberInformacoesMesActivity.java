...
public class ContasReceberInformacoesMesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_contas_receber_informacoes_mes);
    ...
    private void configTabsLayout(){
        ...
        viewPagerAdapter.addFragment(new RelatorioContasReceberInformacoesVMMesFragment(), "Informações");
        viewPagerAdapter.addFragment(new RelatorioContasReceberParcelaVMMesFragment(), "Parcelas");
