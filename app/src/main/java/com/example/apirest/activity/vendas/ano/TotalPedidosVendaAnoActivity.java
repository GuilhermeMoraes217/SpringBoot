...
public class TotalPedidosVendaAnoActivity extends AppCompatActivity implements AdapterTotalPedidoVenda.ItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_total_pedidos_venda_ano);
    ...
    public void onClick(VendasMaster relatorioVendas) {
        Intent intent = new Intent(TotalPedidosVendaAnoActivity.this, InformacoesTotalPedidosVendaActivity.class);
