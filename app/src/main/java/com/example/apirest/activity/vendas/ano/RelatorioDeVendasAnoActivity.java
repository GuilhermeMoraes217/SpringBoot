...
public class RelatorioDeVendasAnoActivity extends AppCompatActivity implements AdapterRelatorioVendas.ItemClickListener {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_relatorio_de_vendas_ano);
    ...
    public void onClick(VendasMaster relatorioVendas) {
        Intent intent = new Intent(RelatorioDeVendasAnoActivity.this, InformacoesPedidoVendaActivity.class);
