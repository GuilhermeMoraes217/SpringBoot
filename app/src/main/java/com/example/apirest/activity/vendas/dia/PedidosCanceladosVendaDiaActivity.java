...
public class PedidosCanceladosVendaDiaActivity extends AppCompatActivity implements AdapterPedidosCanceladoVenda.ItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pedidos_cancelados_venda_dia);
    ...
    public void onClick(VendasMaster relatorioVendas) {
        Intent intent = new Intent(PedidosCanceladosVendaDiaActivity.this, InformacoesPedidosCanceladoVendaActivity.class);
