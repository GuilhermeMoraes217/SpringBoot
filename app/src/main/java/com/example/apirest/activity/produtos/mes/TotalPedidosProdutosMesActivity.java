...
public class TotalPedidosProdutosMesActivity extends AppCompatActivity implements AdapterTotalPedidoVenda.ItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_total_pedidos_produtos_mes);
    ...
    public void onClick(VendasMaster relatorioVendas) {
        Intent intent = new Intent(TotalPedidosProdutosMesActivity.this, InformacoesTotalPedidosVendaActivity.class);
