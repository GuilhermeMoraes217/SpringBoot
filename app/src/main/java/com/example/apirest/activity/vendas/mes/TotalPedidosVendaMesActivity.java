...
public class TotalPedidosVendaMesActivity extends AppCompatActivity implements AdapterTotalPedidoVenda.ItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_total_pedidos_venda_mes);
    ...
    public void onClick(VendasMaster relatorioVendas) {
        Intent intent = new Intent(TotalPedidosVendaMesActivity.this, InformacoesTotalPedidosVendaActivity.class);
