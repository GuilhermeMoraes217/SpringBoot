...
public class TotalPedidosProdutosAnoActivity extends AppCompatActivity implements AdapterTotalPedidoVenda.ItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_total_pedidos_produtos_ano);
    ...
    public void onClick(VendasMaster relatorioVendas) {
        Intent intent = new Intent(TotalPedidosProdutosAnoActivity.this, InformacoesTotalPedidosVendaActivity.class);
