package com.example.apirest.activity.vendas.ano;
...
public class PedidosCanceladosVendaAnoActivity extends AppCompatActivity implements AdapterPedidosCanceladoVenda.ItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pedidos_cancelados_venda_ano);
    ...
    public void onClick(VendasMaster relatorioVendas) {
        Intent intent = new Intent(PedidosCanceladosVendaAnoActivity.this, InformacoesPedidosCanceladoVendaActivity.class);
