package com.example.apirest.adapter.vendas.totalcancelado;
...
public class AdapterInformacaoTotalGrupoPedidoCancelado extends RecyclerView.Adapter<AdapterInformacaoTotalGrupoPedidoCancelado.MyViewHolder> {
    ...
    public AdapterInformacaoTotalGrupoPedidoCancelado(List<VendasDetalhes> vendasDetalhes, Context context, ItemClickListener onClickListener) {
