...
public class AdapterInformacaoTotalGrupoPedidoVenda extends RecyclerView.Adapter<AdapterInformacaoTotalGrupoPedidoVenda.MyViewHolder> {
    ...
    public AdapterInformacaoTotalGrupoPedidoVenda(List<VendasDetalhes> vendasDetalhes, Context context, ItemClickListener onClickListener) {
