...
public class Apis {
    ...
    public static final String URL_005="http://10.0.0.132:8080/empresas/"; // Notebook
    public static final String URL_006="http://10.0.0.132:8080/vendasdetalhes/"; // Notebook
